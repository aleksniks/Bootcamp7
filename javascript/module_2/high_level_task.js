...
do {
  let userInputedPsw = prompt('Input password!');
  if (passwords.includes(userInputedPsw)) {
    alert('Welcome');
    break;
  } else if (userInputedPsw === null) {
    break;
  } else if (attempts === 1) {
    alert('You attempts is over, account is blocked!');
    break;
  } else {
    attempts -= 1;
    alert(`Invalid input, you have ${attempts} attempts`) //  attempts
  }
}
while (0 < attempts)